...
Source description
------------------
Unlike much of my Django code, this app had a base in other code.  The software originated in a Django application named 'menu-generator'. I do not have the technical knowhow nor computing capability to fork the project, so started again.

I wish to acknowledge and thank the authors of 'menu-generator' (who based their own work on 'django-menuware'). Traces of the original code renain in 'django_menus', though these traces are not unique to either original project.

The licence has been modified. See the NOTE distributed with the code.
